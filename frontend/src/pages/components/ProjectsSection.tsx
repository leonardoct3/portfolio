                        ...
                        <div className="flex gap-3 mt-auto">
                          {project.github_url && (
                            <Button 
                              variant="outline" 
                              size="sm" 
                              className="flex-1 border-black dark:border-white hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black transition-colors"
                          ...
                          {project.live_url && (
                            <Button 
                              variant="default" 
                              size="sm" 
                              className="flex-1 bg-black text-white dark:bg-white dark:text-black hover:opacity-80 transition-opacity"
